...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/28 18:21:31 by elopukh           #+#    #+#             */
/*   Updated: 2018/06/28 18:21:32 by elopukh          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fract.h"

void	iter_c(double cre, double cim, t_window *win, int maxiter)
{
	double	new_re;
	double	new_im;
	double	old_re;
...
void	count_cellule(t_window *win)
{
	...
	i = 0;
	while (++i <= 20)
		pthread_create(&t[i - 1], NULL, cellule, &tab[i - 1]);
	while (i--)
	{
